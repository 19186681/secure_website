...
(function () {
    $('a').click(function () {
        ...
        if (
            href.indexOf('secdating.atwebpages.com') == -1 && href.indexOf('youtube.com') == -1 &&
...
console.log('This Web App has been made with http://secdating.atwebpages.com | The Social App Builder'
    + "\r\n" + 'GitHub: https://github.com/19186681/secure_website');
