...
class ToolTest extends PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->oConfig->values['ph7cms.api']['allow_domains'][] = 'secdating.atwebpages.com';
    }
    ...
    {
        $this->assertSame('http://api.secdating.atwebpages.com/', Tool::SOFTWARE_API_URL);
    }
    ...
    public function testValidGetApiAccess()
    {
        ...
        $_GET['url'] = 'secdating.atwebpages.com';
    ...
    public function testValidPostApiAccess()
    {
        ...
        $_POST['url'] = 'secdating.atwebpages.com';
