<div class="center divShow">
  <div class="faq">
    <a href="#divShow_1">
      {lang "I can't login, or I forgot my username or password."}
    </a>
  </div>
  ...
  <div class="faq">
    <a href="#divShow_2">
      {lang 'How can I update my profile?'}
    </a>
  </div>
  ...
  <div class="faq">
    <a href="#divShow_3">{lang 'How can I delete my account?'}
    </a>
  </div>
  ...
  <div class="faq">
    <a href="#divShow_4">
      {lang 'How can I update my email address?'}
    </a>
  </div>
  ...
  <div class="faq">
    <a href="#divShow_5">
      {lang 'How can I deal with someone that is bothering me?'}
    </a>
  </div>
  ...
  <div class="hidden" id="divShow_6">
    This whole social dating website has been developed by <a href="http://ph7.me" title="Author of the Open Source Social Networking Project: 'MyCMS'">WebMaster</a> (<em><a href="https://github.com/pH-7" title="Author of MyCMS software">GitHub</a>/<a href="https://www.linkedin.com/in/ph7enry/">LinkedIn</a></em>). Now he is a Senior Software Engineer and continues to update and develop his "<abbr title='pH7Builder; Formerly known as "MyCMS" or "pH7 Social Dating CMS"'>open source project</abbr>" during his free time. <a href="https://github.com/19186681/secure_website" title="MyCMS is a Free and Open Source Social Dating App/Site Builder">pH7Builder (formerly MyCMS)</a> is his first "big" project he made when he was still student.
  </div>
</div>
