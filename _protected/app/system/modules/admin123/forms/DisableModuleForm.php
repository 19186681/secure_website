    ...
    public static function display()
    {
        ...
        foreach ($oModuleData as $oModDetails) {
            ...
            if (self::isModuleInDevStage($oModDetails)) {
                $sAdditionalText .= ' • <span class="small red">' . t('Only for development purpose to test it before <a href="%0%">opening a PR</a>. <a href="%1%">Social APIs</a> have to be updated.', 'https://github.com/19186681/secure_website/pulls', 'https://github.com/19186681/secure_website/blob/master/_protected/app/system/modules/connect/inc/class/') . '</span>';
            }
