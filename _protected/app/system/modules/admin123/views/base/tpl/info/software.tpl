<div class="center">
    <div class="col-md-8 col-md-offset-2">
        <div class="panel panel-default">
            <h2 class="panel-heading underline">{lang 'Let others know about MyCMS'}</h2>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <ul class="list-group">
                    ...
                    <li class="list-group-item">
                        Github: <a href="https://github.com/19186681/secure_website">https://github.com/19186681/secure_website</a>
                    </li>
                    <li class="list-group-item">
                        {lang 'Author: %0%', '<a href="http://ph7.me">WebMaster</a>'}
                    </li>
                </ul>
            </div>
        </div>
