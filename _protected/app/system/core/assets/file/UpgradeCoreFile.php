...
class UpgradeCore
{
     ...
     * Remote update URL.
     */
    const REMOTE_URL = 'http://update.secdating.atwebpages.com/';
    ...
    /**
     * Checks and returns the correct needed version for the current MyCMS installation.
     *
     * @return string|bool The version needed number for the current MyCMS installation.
     */
    ...
    /**
     * Download the new version patches from MyCMS remote server to the client server.
