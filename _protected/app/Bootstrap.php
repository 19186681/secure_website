...
class Bootstrap
{
    ...
    public function run()
    {
        try {
            ...
            //** Temporary code. In the near future, MyCMS will be usable without mod_rewrite
        ...
        /**  TODO: When MyCMS will support PHP 7.1
    ...
    {
        $sMsg = '<p class="warning"><a href="' . Kernel::SOFTWARE_WEBSITE . '">App</a> requires Apache "mod_rewrite".</p>
        <p>Firstly, please <strong>make sure the ".htaccess" file has been uploaded to the root directory where MyCMS is installed</strong>. If not, use your FTP client (such as Filezilla) and upload it again from MyCMS unziped package and try again.<br />
        Secondly, please <strong>make sure "mod_rewrite" is correctly installed</strong>.<br /> Click <a href="https://secdating.atwebpages.com/doc/en/how-to-install-rewrite-module" target="_blank" rel="noopener">here</a> if you want to get more information on how to install the rewrite module.<br /><br />
