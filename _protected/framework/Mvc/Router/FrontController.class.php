 ...
 *
 * This class is used to instantiate the Controller and the action with the MVC pattern.
...
final class FrontController
{
    ...
    {
        // The following code will be useless if MyCMS will be able to work without mod_rewrite
