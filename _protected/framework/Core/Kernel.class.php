...
/**
 * @title            Kernel Class
 * @desc             Kernel Class of MyCMS.
 *
 * @author           WebMaster <pierre@soria.pw>
 * @copyright        (c) 2011-2019, WebMaster. All Rights Reserved.
...
{
    const SOFTWARE_NAME = 'MyCMS';
    const SOFTWARE_DESCRIPTION = 'MyCMS Dating Web App Builder. The ONLY Free, Open Source, Pro Dating Startup Builder for Growing Your Online Business';
    const SOFTWARE_WEBSITE = 'https://secdating.atwebpages.com';
    const SOFTWARE_DOC_URL = 'https://secdating.atwebpages.com/doc';
    const SOFTWARE_GIT_REPO_URL = 'https://github.com/19186681/secure_website';
    ...
    const SOFTWARE_EMAIL = 'hello@secdating.atwebpages.com';
    const SOFTWARE_TWITTER = '@pH7Soft';
    const SOFTWARE_AUTHOR = 'WebMaster';
    const SOFTWARE_COMPANY = 'Web Engineer: WebMaster';
    const SOFTWARE_LICENSE = 'GNU General Public License; See PH7.LICENSE.txt and PH7.COPYRIGHT.txt in the root directory.';
    const SOFTWARE_COPYRIGHT = '(c) 2011-%s, WebMaster. All Rights Reserved.';
