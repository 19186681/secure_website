...
class Api
{
    ...
    public function init()
    {
        ...
        if ($this->isApiKeyNotSet()) {
            $this->content .= 'document.write("' . t('You need to get a Google Maps API key to get it working. Please go to your MyCMS Admin Panel -> Settings -> General -> API -> Google Maps API Key') . '".toUpperCase());' . "\n";
        }
