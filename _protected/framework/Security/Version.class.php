 ...
 * @copyright        (c) 2012-2020, WebMaster. All Rights Reserved.
...
final class Version
{
    ...
    const LATEST_VERSION_URL = 'http://xml.secdating.atwebpages.com/software-info.xml';
    const VERSION_PATTERN = '\d{1,2}\.\d{1,2}\.\d{1,2}';
    const FRAMEWORK_TAG_NAME = 'ph7';
    const PACKAGE_TAG_NAME = 'ph7builder';

    const UPGRADE_DOC_URL = 'https://secdating.atwebpages.com/doc/en/upgrade';
     ...
     *
     * More details: https://secdating.atwebpages.com/new-versioning-system/
     */
    ...
    /***** Framework Server *****/
    const KERNEL_TECHNOLOGY_NAME = 'secdating.atwebpages.com';
