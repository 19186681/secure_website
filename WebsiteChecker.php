...
class WebsiteChecker
{
    ...
    const PHP_VERSION_ERROR_MESSAGE = 'ERROR: Your current PHP version is %s. App requires PHP %s or newer.<br /> Please ask your Web host to upgrade PHP to %s or newer.';
