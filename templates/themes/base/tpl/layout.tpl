...
<html lang="{% $config->values['language']['lang'] %}">
  <head>
    ...
    <!-- Begin Copyright pH7 Dating/Social CMS by WebMaster, All Rights Reserved -->
    <!-- Do not modify or remove this code! Think of those who spend a lot of time to develop this CMS & Framework for you -->
    <meta name="creator" content="MyCMS, WebMaster - {software_url}" />
    <meta name="designer" content="MyCMS, WebMaster - {software_url}" />
